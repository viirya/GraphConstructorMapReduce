...
public class GraphConstructorMapReduceMinHashPreCompute {
...
*/
    ...
    public static class PairwiseSimilarityComputationMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        public void map(LongWritable key, Text value, Context context) throws NumberFormatException, IOException, InterruptedException {
            ...
            if (image_id_and_feature_value.equals("1")) {
                context.write(new Text(feature_id), new DoubleWritable(-1.0d));
                return;
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 3) {
            System.out.println("Usage: GraphConstructorMapReduceMinHashPreCompute <input path> <cluster path> <threshold> [compress]");    
            System.exit(0);
        }
    ...
    public static Pair calculate_adl(String input_path) throws Exception {
        ...
        job_adl_calculator.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
    ...
    public static void calculate_tf(String input_path, double adl) throws Exception {
        ...
        job_tfidf_tf_calculator.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
    ...
    public static void calculate_idf(String input_path, int number_of_images) throws Exception {
        ...
        job_tfidf_idf_calculator.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
    ...
    public static void addminhashinfo(String cluster_path, int min_cluster_size) throws Exception {
        ...
        job_addminhashinfo.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
    ...
    public static void construct_inverted_list(String input_path) throws Exception {
        ...
        job_inverted_list_constructor.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
    ...
    public static void compute_pairwise_similarity(String input_path, double threshold) throws Exception {
        ...
        job_pairwise_similarity_computation.setJarByClass(GraphConstructorMapReduceMinHashPreCompute.class);
