...
public class GraphConstructorMapReduceMinHashFeatureFilterPreCompute {
...
*/
    ...
    public static class PrePairwiseSimilarityComputationMapper extends Mapper<LongWritable, Text, Text, FloatWritable> {
        public void map(LongWritable key, Text value, Context context) throws NumberFormatException, IOException, InterruptedException {
            ...
            if (image_id_and_feature_value.equals("1")) {
                // image pair
                FloatWritable fake_value = new FloatWritable();
                fake_value.set(-1.0f);
                context.write(new Text(feature_id), fake_value);
            } else {
                ...
                Text image_pair = new Text();
                FloatWritable similarity = new FloatWritable();
                for(int i = 0; i < image_id.length; i++) {
                    for(int j = i + 1; j < image_id.length; j++) {
                        ...
                        if (l_raw_value > threshold && r_raw_value > threshold) {
                            ...
                            similarity.set(l_value * r_value);
    ...
    public static class PrePairwiseSimilarityComputationCombiner extends Reducer<Text, FloatWritable, Text, FloatWritable> {
        public void reduce(Text key, Iterable<FloatWritable> values, Context context) throws IOException, InterruptedException {
            ...
            if (similarity > 0.0f)
                context.write(key, new FloatWritable(similarity));
        }
    }
 
    public static class PrePairwiseSimilarityComputationReducer extends Reducer<Text, FloatWritable, Text, Text> {
        public void reduce(Text key, Iterable<FloatWritable> values, Context context) throws IOException, InterruptedException {
            ...
            if (in_min_hash_bin && similarity > 0.0f)
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 4) {
            System.out.println("Usage: GraphConstructorMapReduceMinHashFeatureFilterPreCompute <input path> <cluster path> <threshold> <cluster min size> [compress]");    
            System.exit(0);
        }
    ...
    public static Pair calculate_adl(String input_path) throws Exception {
        ...
        job_adl_calculator.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
    ...
    public static void calculate_tf(String input_path, double adl) throws Exception {
        ...
        job_tfidf_tf_calculator.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
    ...
    public static void calculate_idf(String input_path, int number_of_images) throws Exception {
        ...
        job_tfidf_idf_calculator.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
    ...
    public static void addminhashinfo(String cluster_path, int min_cluster_size) throws Exception {
        ...
        job_addminhashinfo.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
    ...
    public static void construct_inverted_list(String input_path) throws Exception {
        ...
        job_inverted_list_constructor.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
    ...
    public static void pre_compute_pairwise_similarity(String input_path, String image_pairs_path, float threshold) throws Exception {
        ...
        job_pairwise_similarity_computation.setJarByClass(GraphConstructorMapReduceMinHashFeatureFilterPreCompute.class);
        ...
        job_pairwise_similarity_computation.setMapOutputValueClass(FloatWritable.class);
